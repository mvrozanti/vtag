"""Env-driven configuration for the vtag CLI."""
...
VLM_MODEL: str = os.getenv("VTAG_VLM_MODEL", "qwen2.5vl:7b")
...
VLM_KEEP_ALIVE: str = os.getenv("VTAG_VLM_KEEP_ALIVE", "10m")
...
GPU_BUSY_RETRY_CAP_SECONDS: float = float(os.getenv("VTAG_BUSY_CAP", "1800"))

BASE_DIR: Path = Path(__file__).resolve().parent
STATE_DIR: Path = Path(os.getenv("VTAG_STATE_DIR", str(Path.home() / ".local/share/vtag")))
LOG_DIR: Path = Path(os.getenv("VTAG_LOG_DIR", str(STATE_DIR / "logs")))
